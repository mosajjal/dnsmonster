---
title: InfluxDB
description: Configure the dnsmonster InfluxDB output — server, token, bucket, org, workers and batch size.
sidebar:
  order: 8
---

InfluxDB is a time series database used to store logs and metrics at high ingestion rates.
