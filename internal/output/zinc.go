...
type zincConfig struct {
	...
	ZincOutputEndpoint string        `long:"zincoutputendpoint"       ini-name:"zincoutputendpoint"       env:"DNSMONSTER_ZINCOUTPUTENDPOINT"       default:""                    description:"zinc endpoint address, example: http://127.0.0.1:9200/api/default/default/_bulk. Used if zincOutputType is not none"`
