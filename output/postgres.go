...
type psqlConfig struct {
	...
	PsqlBatchSize     uint          `long:"psqlBatchSize"           env:"DNSMONSTER_PSQLBATCHSIZE"           default:"1"                                                       description:"Psql Batch Size"`
	PsqlBatchDelay    time.Duration `long:"psqlBatchDelay"          env:"DNSMONSTER_PSQLBATCHDELAY"          default:"0s"                                                      description:"Interval between sending results to Psql if Batch size is not filled. Any value larger than zero takes precedence over Batch Size"`
	PsqlBatchTimeout  time.Duration `long:"psqlBatchTimeout"        env:"DNSMONSTER_PSQLBATCHTIMEOUT"        default:"5s"                                                      description:"Timeout for any INSERT operation before we consider them failed"`
	PsqlSaveFullQuery bool          `long:"psqlSaveFullQuery"       env:"DNSMONSTER_PSQLSAVEFULLQUERY"       description:"Save full packet query and response in JSON format."`
