...
var generalOptions struct {
	Config                      flags.Filename `long:"config"                      env:"DNSMONSTER_CONFIG"                      default:""                                                        description:"path to config file"`
	...
	MaskSize                    int            `long:"maskSize"                    env:"DNSMONSTER_MASKSIZE"                    default:"32"                                                      description:"Mask source IPs by bits. 32 means all the bits of IP is saved in DB"`
